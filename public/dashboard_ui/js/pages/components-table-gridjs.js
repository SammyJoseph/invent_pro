window.addEventListener("app:mounted", (function() {
    ...
    new Popper("#dropdown-wrapper1", ".popper-ref", ".popper-root", e), new Popper("#dropdown-wrapper2", ".popper-ref", ".popper-root", e), new Popper("#dropdown-wrapper3", ".popper-ref", ".popper-root", e), new Popper("#dropdown-wrapper4", ".popper-ref", ".popper-root", e);
    var a = document.querySelector("#grid-table-1"),
        t = a.querySelector("[data-grid-ref]"),
        r = a.querySelector("[data-grid-wrapper]");
    a._table = new Gridjs.Grid({
        from: t,
        sort: !0,
        search: !0
    }).render(r);
    var n = document.querySelector("#grid-table-2");
    n._table = new Gridjs.Grid({
        data: [{
            id: 59,
    ...
    var i = document.querySelector("#grid-table-3");
    i._table = new Gridjs.Grid({
        pagination: !0,
        search: {
            server: {
                url: function(e, a) {
                    return "".concat(e, "?search=").concat(a)
                }
            }
        },
        sort: !0,
        ...
        server: {
            ...
            then: function(e) {
                return e.results.map((function(e) {
                    return [e.title, e.director, e.producer]
                }))
            }
        }
    }).render(i);
