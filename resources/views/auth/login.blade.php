                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">¿Perdiste tu contraseña?</a>
                                </div>
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    ¿No estás registrado aún? <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500 underline">Crea tu cuenta aquí</a>
                                </p>
                            </form>
                        </div>
                    </div>
