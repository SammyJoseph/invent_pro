        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="col-span-12 lg:col-span-8">
                <div class="flex items-center justify-between space-x-2">
                    ...
                    <div id="sales-tab" class="is-scrollbar-hidden overflow-x-auto rounded-lg bg-slate-200 text-slate-600 dark:bg-navy-800 dark:text-navy-200">
                        <div class="tabs-list flex p-1">
                            <button data-target="#sales-recent-tab" class="tab btn shrink-0 px-3 py-1 text-xs+ font-medium" data-active-class="bg-white shadow dark:bg-navy-500 dark:text-navy-100"
                                data-default-class="hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100">
                                Last month
                            </button>
                            <button data-target="#sales-all-tab" class="tab btn shrink-0 px-3 py-1 text-xs+ font-medium" data-active-class="bg-white shadow dark:bg-navy-500 dark:text-navy-100"
                                data-default-class="hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100">
                                Last year
                            </button>
                        </div>
                            ...
                            <div class="mt-8 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar h-8 w-8 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('dashboard_ui/images/200x200.png') }}" alt="avatar" />
                                    </div>
                                    <div class="avatar h-8 w-8 hover:z-10">
            ...
            <div class="col-span-12 lg:col-span-4">
                ...
                <div class="mt-4 flex h-2 space-x-1">
                    <div class="w-5/12 rounded-full bg-primary dark:bg-accent" data-tooltip="Exellent" data-theme="primary"></div>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            ...
            <div class="is-scrollbar-hidden col-span-12 flex space-x-4 overflow-x-auto px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-9 lg:pl-0">
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    <div class="flex items-center justify-between space-x-2">
                        <div class="flex items-center space-x-3">
                            <div class="avatar">
                                <img class="mask is-squircle" src="{{ asset('dashboard_ui/images/200x200.png') }}" alt="image" />
                            </div>
                            <div>
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 1" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-19.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-2.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-5.svg') }}" alt="avatar" />
                        </div>
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 1" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-1.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-6.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-9.svg') }}" alt="avatar" />
                        </div>
                        <button class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-14.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-13.svg') }}" alt="avatar" />
                        </div>
                        <button class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-15.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-13.svg') }}" alt="avatar" />
                        </div>
                        <button class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-15.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-5.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-25.svg') }}" alt="avatar" />
                        </div>
                        <button class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="flex justify-between">
                        <div class="flex space-x-2">
                            <img data-tooltip="Award Level 2" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-1.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-24.svg') }}" alt="avatar" />
                            <img data-tooltip="Award Level 3" class="h-6 w-6" src="{{ asset('dashboard_ui/images/awards/award-30.svg') }}" alt="avatar" />
                        </div>
                        <button class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-item-content flex-1 pl-4 sm:pl-8">
                            ...
                            <div class="avatar mt-2 h-16 w-16">
                                <img class="mask is-squircle" src="{{ asset('dashboard_ui/images/200x200.png') }}" alt="avatar" />
                            </div>
                        </div>
                    </li>
                    <li class="timeline-item">
