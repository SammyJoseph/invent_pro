                ...
                <div>
                    ...
                    <div class="flex -space-x-3">
                        ...
                        <img
                            ...
                            src="{{ asset('dashboard_ui/images/200x200.png') }}"
                            alt="avatar"
                        />
                        </div>
                        <div class="avatar h-8 w-8 hover:z-10">
        ...
        >
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-19.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 2"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-2.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-5.svg') }}"
                    alt="avatar"
                    />
                </div>
                <button
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    data-tooltip="Award Level 1"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-1.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 2"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-6.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-9.svg') }}"
                    alt="avatar"
                    />
                </div>
                <button
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    data-tooltip="Award Level 2"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-14.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-13.svg') }}"
                    alt="avatar"
                    />
                </div>
                <button
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    data-tooltip="Award Level 2"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-15.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 3"
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-25.svg') }}"
                    alt="avatar"
                    />
                </div>
                <button
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex space-x-2">
                    ...
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-24.svg') }}"
                    alt="avatar"
                    />
                    <img
                    data-tooltip="Award Level 3"
                    class="h-6 w-6"
                    src="{{ asset('dashboard_ui/images/awards/award-30.svg') }}"
                    alt="avatar"
                    />
                </div>
                <button
